...
injectScript('js/customer_system_interceptor.js');

// 허브가 자동 연쇄로 보낸 명령 — 사용자 클릭이 없다.
onCommand('DO_APPLY_RESERVATION_TO_MEMO', async (msg) => {
  const memo = await waitForElement('textarea.memo');
...
onIntercepted('INBOUND_CALLBACK', (calls) => {
